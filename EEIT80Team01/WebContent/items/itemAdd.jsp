...
<div class="col-md-8">
<form action="${pageContext.request.contextPath }/items/itemAdd.controller" method="post" enctype="multipart/form-data" role="form" class="form-horizontal"> 
...
<script>
   $(document).ready(function(){ 
	...
	<div class="col-sm-offset-6">
		...
		<input type="button" value="清除內容" onclick="clearForm()">
