...
public class SearchDAOJdbc implements SearchDAO {
	...
	private String getItemsByKeyword = "select * from ITEMS where TITLE like ? order by ITEM_ID desc";
	/* (non-Javadoc)
	...
	private String getItemsWithOption = "select * from ITEMS where ITEM_CATEGORY = ? and  TITLE like ? order by ITEM_ID desc";
	/* (non-Javadoc)
